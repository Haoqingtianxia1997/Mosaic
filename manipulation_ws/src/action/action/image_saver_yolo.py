...
class ImageSaver(Node):
    def __init__(self):
        super().__init__('image_saver_yolo')
        ...
        self.output_dir = os.path.join(os.getcwd(), '/home/mosaic/mosaic/manipulation_ws/saved_images_yolo')
    ...
    def auto_save(self):
        ...
        for cam in ['l', 'r']:
            ...
            rgb_path = os.path.join(self.output_dir, f"{cam}_rgb_{timestamp}.png")
            # depth_npy_path = os.path.join(self.output_dir, f"{cam}_depth_{timestamp}.npy")
            # depth_png_path = os.path.join(self.output_dir, f"{cam}_depth_{timestamp}.png")

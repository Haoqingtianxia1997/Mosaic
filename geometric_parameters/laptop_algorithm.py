# laptop - Geometric Analysis Algorithm
# Primitives: {'base': ['box'], 'screen': ['box']}

import numpy as np
import open3d as o3d
from sklearn.decomposition import PCA

def extract_parameters(points_dict):
    parameters = {}
    ...
    for part_name, points in points_dict.items():
        ...
        dimensions *= 1.02  # Add margin
        
        if not is_axis_aligned:
            parameters[f'{part_name}_component_0'] = {
                'type': 'box',

...

{
  ...
  "actions": [
    {
      "type": "<perceive | move | grasp | stir | place | reset | add |back_move>",
...
- add  
  ...
  · parameters:  
        "amount" (string, optional) — e.g. "a pinch", "1 tsp"
- back_move
  · Move the arm back to a original position of object after an action, for example: after adding salt, move the arm back to a original position of salt bottle.
  · parameters: none
-----------------------------------------------------------------------
GENERAL RULES
...

{
  ...
  "actions": [
    ...
    { "type": "grasp",    "target": "salt bottle", "parameters": {} },
...

{
  ...
  "actions": [
    ...
    { "type": "add",      "target": "soup pot",    "parameters": { "amount": "a pinch" } },
    { "type": "back_move","target": "salt bottle", "parameters": {} },
...

{
  ...
  "actions": [
    ...
    { "type": "grasp",    "target": "spoon",       "parameters": {} },
    { "type": "perceive", "target": "soup pot",    "parameters": {} },
    { "type": "move",     "target": "soup pot",    "parameters": {} },
    { "type": "stir",     "target": "soup pot",    "parameters": { "duration": 10 } },
    { "type": "back_move","target": "spoon rest",  "parameters": {} },
...

{
  ...
  "actions": [
    ...
    { "type": "grasp",    "target": "pepper bottle", "parameters": {} },
...

{
  ...
  "actions": [
    ...
    { "type": "grasp",    "target": "apple",        "parameters": {} },
    { "type": "perceive", "target": "user person",  "parameters": {} },
    { "type": "move",     "target": "user person",  "parameters": {} },
    { "type": "place",    "target": "user person",  "parameters": {} },
    { "type": "reset",    "target": "home",         "parameters": {} }
